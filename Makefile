...
Button.o: Button.cc Button.hh MenuElement.hh Vector2.hh Window.hh Scene.hh
	$(CXX) $(CFLAGS) -c -o $@ $<

MenuElement.o: MenuElement.cc MenuElement.hh Vector2.hh Window.hh Scene.hh
	$(CXX) $(CFLAGS) -c -o $@ $<

MenuScene.o: MenuScene.cc Window.hh Scene.hh Vector2.hh MenuScene.hh Button.hh MenuElement.hh timings.hh
	$(CXX) $(CFLAGS) -c -o $@ $<

racer.o: racer.cc Window.hh Scene.hh Vector2.hh
	$(CXX) $(CFLAGS) -c -o $@ $<
